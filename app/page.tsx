...
import { generateCarBrandData, generateRegionData, getRegionStats } from "@/lib/data"
  ...
  return (
    <div className="flex-1 space-y-4 p-4 md:p-8 pt-6">
      ...
      <div className="grid gap-4 md:grid-cols-3">
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Most Claimed Region</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold">{stats.topRegion}</div>
            <p className="text-xs text-muted-foreground">Highest number of claims</p>
          </CardContent>
        </Card>
      </div>
      ...
      <Tabs defaultValue="map" className="space-y-4">
        <TabsList>
          <TabsTrigger value="map">Claims Heatmap</TabsTrigger>
          <TabsTrigger value="regions">Claims by Region</TabsTrigger>
          <TabsTrigger value="cars">Claims by Car Brand</TabsTrigger>
        </TabsList>
        <TabsContent value="map" className="space-y-4">
          <Card>
            <CardHeader>
              <CardTitle>Italy Claims Heatmap</CardTitle>
              <CardDescription>Geographic distribution of insurance claims across Italy</CardDescription>
            </CardHeader>
            <CardContent className="flex justify-center p-6">
              <ItalyMap regionData={regionData} />
            </CardContent>
          </Card>
        </TabsContent>
        <TabsContent value="regions" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Number of claims submitted per region</CardDescription>
            </CardHeader>
        ...
        <TabsContent value="cars" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Distribution of claims by customer car brand</CardDescription>
            </CardHeader>
            <CardContent className="h-[400px]">
